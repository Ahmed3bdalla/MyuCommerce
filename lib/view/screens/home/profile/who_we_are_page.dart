      ...
      body: Padding(
        ...
        child: SingleChildScrollView(
          ...
          child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
            const CustomText(text: "من نحن؟", size: 30, color: kPrimaryColor),
            const SizedBox(
              height: 10,
            ),
            Column(
            ...
            const CustomText(text: "رؤيتنا", size: 20, color: Colors.green),
            const Text(
            ...
            const CustomText(
                text: "سياسة الجودة", size: 20, color: Colors.green),
            const Text(
            ...
            const CustomText(text: "رسالتنا", size: 20, color: Colors.green),
            const Text(
